...
class CartProductLazyArray extends ProductLazyArray
{
    /**
    ...
    public function addQuantityInformation(
        ...
        /*
         * For all labels, we will primarily use label from combination if set,
         * then label on product, then the default label from PS settings.
         */
        ...
        // Ordered items are partially in stock
            ...
            // Define first part of the message
            if (!empty($combinationData['available_now'])) {
            ...
            // And the part for other products
